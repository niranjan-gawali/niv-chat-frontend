...
export type GetMyInformationQuery = {
  __typename?: 'Query';
  getMyInformation: {
    __typename?: 'UserBasicOutput';
    _id: string;
...
export const FindChatsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'findChats' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'groupAdmin' },
                      },
                      {
                        kind: 'Field',
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'isLoggedInUser' },
                            },
                          ],
                        },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'isGroupChat' },
                      },
                    ],
                  },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'totalChatCount' },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<FindChatsQuery, FindChatsQueryVariables>;
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'getMessageInput' },
                value: {
                  kind: 'ObjectValue',
                  fields: [
                    {
...
export const GetMyInformationDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetMyInformation' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetMyInformationQuery,
  GetMyInformationQueryVariables
>;
export const FindChatDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'FindChat' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'groupAdmin' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'lastMessage' },
                  selectionSet: {
...
} as unknown as DocumentNode<FindChatQuery, FindChatQueryVariables>;
